...
_thread_test1:     file format elf32-i386
...
main(int argc, char *argv[])
{
 ...
 int x=3,y=4;
    1016:	c7 45 f0 03 00 00 00 	movl   $0x3,-0x10(%ebp)
  printf(1, "RUNNING..\n");
    101d:	68 3e 19 00 00       	push   $0x193e
    1022:	6a 01                	push   $0x1
 int x=3,y=4;
    1024:	c7 45 f4 04 00 00 00 	movl   $0x4,-0xc(%ebp)
  printf(1, "RUNNING..\n");
    102b:	e8 00 07 00 00       	call   1730 <printf>
  printf(1, "hi 'm parent\n");
    1030:	58                   	pop    %eax
    1031:	5a                   	pop    %edx
    1032:	68 49 19 00 00       	push   $0x1949
    1037:	6a 01                	push   $0x1
    1039:	e8 f2 06 00 00       	call   1730 <printf>
 int a= thread_create(&f1, (void *)&x , (void *)&y);
    103e:	83 c4 0c             	add    $0xc,%esp
    1041:	8d 45 f4             	lea    -0xc(%ebp),%eax
    1044:	50                   	push   %eax
    1045:	8d 45 f0             	lea    -0x10(%ebp),%eax
    1048:	50                   	push   %eax
    1049:	68 a0 10 00 00       	push   $0x10a0
    104e:	e8 1d 05 00 00       	call   1570 <thread_create>
    1053:	89 c3                	mov    %eax,%ebx
  thread_join();
    1055:	e8 f6 02 00 00       	call   1350 <thread_join>
  printf(1, "1st thread pid: %d\n",a);
    105a:	83 c4 0c             	add    $0xc,%esp
    105d:	53                   	push   %ebx
    105e:	68 57 19 00 00       	push   $0x1957
    1063:	6a 01                	push   $0x1
    1065:	e8 c6 06 00 00       	call   1730 <printf>
  printf(1, "FINISHING .\n");
    106a:	59                   	pop    %ecx
    106b:	5b                   	pop    %ebx
    106c:	68 6b 19 00 00       	push   $0x196b
    1071:	6a 01                	push   $0x1
    1073:	e8 b8 06 00 00       	call   1730 <printf>
  exit();
    1078:	e8 20 05 00 00       	call   159d <exit>
...
void f2(void* x,void *y){
    ...
    1087:	83 ec 10             	sub    $0x10,%esp
printf(1,"I'm 1st thread's child \n");
    108a:	68 f8 18 00 00       	push   $0x18f8
    108f:	6a 01                	push   $0x1
    1091:	e8 9a 06 00 00       	call   1730 <printf>
 thread_join();
    1096:	e8 b5 02 00 00       	call   1350 <thread_join>
exit();
    109b:	e8 fd 04 00 00       	call   159d <exit>
...
printf(1,"I'm 1st thread \n");
    10ab:	68 11 19 00 00       	push   $0x1911
    10b0:	6a 01                	push   $0x1
    10b2:	e8 79 06 00 00       	call   1730 <printf>
int a = thread_create(&f2, x , y);
    10b7:	83 c4 0c             	add    $0xc,%esp
    10ba:	ff 75 0c             	pushl  0xc(%ebp)
    10bd:	ff 75 08             	pushl  0x8(%ebp)
    10c0:	68 80 10 00 00       	push   $0x1080
    10c5:	e8 a6 04 00 00       	call   1570 <thread_create>
    10ca:	89 c3                	mov    %eax,%ebx
 thread_join();
    10cc:	e8 7f 02 00 00       	call   1350 <thread_join>
  printf(1, "1st thread's child pid: %d\n",a);
    10d1:	83 c4 0c             	add    $0xc,%esp
    10d4:	53                   	push   %ebx
    10d5:	68 22 19 00 00       	push   $0x1922
    10da:	6a 01                	push   $0x1
    10dc:	e8 4f 06 00 00       	call   1730 <printf>
exit();
    10e1:	e8 b7 04 00 00       	call   159d <exit>
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    13d5:	a1 04 1d 00 00       	mov    0x1d04,%eax
{
    ...
    13f6:	73 10                	jae    1408 <free+0x38>
{
  ...
  freep = p;
    ...
    1421:	5b                   	pop    %ebx
  freep = p;
    1422:	a3 04 1d 00 00       	mov    %eax,0x1d04
}
    1427:	5e                   	pop    %esi
    1428:	5f                   	pop    %edi
    1429:	5d                   	pop    %ebp
  ...
  freep = p;
    144a:	a3 04 1d 00 00       	mov    %eax,0x1d04
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
    1470:	8b 3d 04 1d 00 00    	mov    0x1d04,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
  ...
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    14b9:	8b 3d 04 1d 00 00    	mov    0x1d04,%edi
  ...
  return freep;
    14e7:	a1 04 1d 00 00       	mov    0x1d04,%eax
    ...
    1514:	89 72 04             	mov    %esi,0x4(%edx)
      freep = prevp;
    1517:	a3 04 1d 00 00       	mov    %eax,0x1d04
}
    ...
    base.s.ptr = freep = prevp = &base;
    1530:	c7 05 04 1d 00 00 08 	movl   $0x1d08,0x1d04
    1537:	1d 00 00 
    base.s.size = 0;
    153a:	bf 08 1d 00 00       	mov    $0x1d08,%edi
    base.s.ptr = freep = prevp = &base;
    153f:	c7 05 08 1d 00 00 08 	movl   $0x1d08,0x1d08
    1546:	1d 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    1549:	89 f8                	mov    %edi,%eax
    base.s.size = 0;
    154b:	c7 05 0c 1d 00 00 00 	movl   $0x0,0x1d0c
    1552:	00 00 00 
    if(p->s.size >= nunits){
    ...
    168c:	89 d1                	mov    %edx,%ecx
{
  ...
  do{
    ...
    16b9:	0f b6 92 80 19 00 00 	movzbl 0x1980(%edx),%edx
...
printf(int fd, const char *fmt, ...)
{
  ...
  write(fd, &c, 1);
    ...
    18b4:	eb 1a                	jmp    18d0 <printf+0x1a0>
          s = "(null)";
    18b6:	bb 78 19 00 00       	mov    $0x1978,%ebx
        while(*s != 0){
